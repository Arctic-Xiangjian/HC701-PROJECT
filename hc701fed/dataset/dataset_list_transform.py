...
MESSIDOR_binary_pairs_test = MESSIDOR_binary(data_dir=MESSIDOR_binary_dir_options['messidor_pairs'], mode='test', transform_=None)
MESSIDOR_binary_Etienne_test = MESSIDOR_binary(data_dir=MESSIDOR_binary_dir_options['messidor_Etienne'], mode='test', transform_=None)
MESSIDOR_binary_Brest_test = MESSIDOR_binary(data_dir=MESSIDOR_binary_dir_options['messidor_Brest-without_dilation'], mode='test', transform_=None)
